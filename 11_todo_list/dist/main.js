...
function formatDate(dueDate) {
  return (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.format)(new Date(dueDate), "MMMM d");
}


/***/ }),

/***/ "./src/scripts/dateElement.js":
/*!************************************!*\
  !*** ./src/scripts/dateElement.js ***!
  \************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _date_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./date.js */ "./src/scripts/date.js");
...
const DateElement = {
  ...
  createDateElements(dueDate, isComplete) {
    ...
    dateText.innerHTML = (0,_date_js__WEBPACK_IMPORTED_MODULE_0__.formatDate)(dueDate);
  ...
  handleDateChange(
    ...
    if (dateInput.value !== task.dueDate) {
      updateTaskDueDateCallback(projectId, task.id, dateInput.value);
      dateText.innerHTML = (0,_date_js__WEBPACK_IMPORTED_MODULE_0__.formatDate)(dateInput.value);
    }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (DateElement);
...
/* harmony export */ });
/* harmony import */ var _dateElement_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dateElement.js */ "./src/scripts/dateElement.js");
...
class DOMElements {
  ...
  createTaskListItem(projectId, task) {
    ...
    const dueDateElement = _dateElement_js__WEBPACK_IMPORTED_MODULE_0__["default"].createDueDateElement(
      projectId,
      task,
